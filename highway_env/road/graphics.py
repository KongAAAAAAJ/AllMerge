...
class RoadGraphics(object):
    ...
    def display_traffic(
        ...
        # Show all cars' history trajectories
        ...
        # Show controlled cars' planning trajectories
        if road.show_future_trajectory:
            for v in road.vehicles:
                if type(v).__name__ == 'FOLLOWVehicle':
                    VehicleGraphics.display_trajectory(
                        vehicle=v, surface=surface, offscreen=offscreen
                    )
